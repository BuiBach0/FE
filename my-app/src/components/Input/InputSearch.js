  ...
  return (
    <div>
       <div className='inputSearch'>
                                {/* <svg className='icon_back' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <input
                                    ...
                                    placeholder="Search..."
                                />
                                {/* <svg className='icon_search' width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg className='icon_ring' width="17" height="20" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg">
